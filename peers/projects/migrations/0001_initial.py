    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(choices=[('coal', 'Coal'), ('nuclear', 'Nuclear'), ('cas', 'Gas'), ('Petroleum', 'Petroleum'), ('simple gas', 'Simple Gas'), ('wind', 'Wind'), ('hydro', 'Hydro'), ('other', 'Other')], default='other', max_length=20, verbose_name='Fuel Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(choices=[('coal', 'Coal'), ('nuclear', 'Nuclear'), ('gas', 'Gas'), ('petroleum', 'Petroleum'), ('simple-gas', 'Simple Gas'), ('wind', 'Wind'), ('other', 'Other')], default='other', max_length=20, verbose_name='Fuel Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_score', models.FloatField(blank=True, default=0, null=True, verbose_name='Project Score')),
                ('sei_score', models.FloatField(blank=True, default=0, null=True, verbose_name='SEI Score')),
                ('lre_score', models.FloatField(blank=True, default=0, null=True, verbose_name='LRE Strategy Score')),
                ('net_metering_score', models.FloatField(blank=True, default=0, null=True, verbose_name='Net Metering Score')),
                ('bulk_sei', models.FloatField(blank=True, null=True, verbose_name='Bulk SEI value')),
                ('ees_value', models.FloatField(blank=True, null=True, verbose_name='Electricity Efficiency Savings')),
                ('oe_credit_score', models.FloatField(blank=True, default=0, null=True, verbose_name='OE Credit Score')),
                ...
                ('currency', models.CharField(blank=True, choices=[('USD', 'Dollar'), ('INR', 'Rupee')], max_length=20, null=True, verbose_name='Default Currency')),
                ...
                ('annual_fuel_cost', models.IntegerField(default=0, verbose_name='Avrage Annual Fuel Cost')),
                ('customer_meter_perc', models.CharField(blank=True, choices=[('RANGE1', 'Less than 5%'), ('RANGE2', 'Between 5% to 50%'), ('RANGE3', '50% or More')], max_length=7, null=True, verbose_name='Customer percentage Installed Advance Meter')),
                ('current_customer_meter_perc', models.CharField(blank=True, max_length=3, null=True, verbose_name='Customer percentage Installed Advance Meter')),
                ('customer_served_meter_perc', models.CharField(blank=True, max_length=3, null=True, verbose_name='Customer Served by Meter in last 4yrs')),
                ('customer_elec_load_supplied', models.FloatField(blank=True, null=True, verbose_name='Percentage of Customer Electricity Load Supplied')),
                ...
                ('hydro_elec', models.IntegerField(blank=True, default=0, verbose_name='Hydro Electricity Generation')),
                ...
                ('hydro_elec_capacity', models.IntegerField(blank=True, null=True, verbose_name='Hydro Electricity Generation')),
