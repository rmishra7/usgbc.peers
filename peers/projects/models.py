...
class ProjectSpecificInfo(models.Model):
    ...
    oe_credit_score = models.FloatField(_("OE Credit Score"), blank=True, null=True, default=0)
    ...
    annual_purchased_elec = models.IntegerField(_("Annual Purchased Electricity"), blank=True, null=True)
    purchased_hr_peak_demand = models.IntegerField(_("Purchased annual hourly peak demand"), blank=True, null=True)
    ...
    annual_fuel_cost = models.IntegerField(_("Avrage Annual Fuel Cost"), default=0)
    ...
    chp_elec = models.IntegerField(_("Local CHP natual gas Electricity Generation"), blank=True, default=0)
    high_efficiency_gas_elec = models.IntegerField(_("Local High Efficiency Electricity generation"), blank=True, default=0)
    local_other_gas_elec = models.IntegerField(_("Local other Gas Electricity Generation"), blank=True, default=0)
    ...
    tot_local_generation_capacity = models.IntegerField(_("Total Local Electricity Generation Capacity"), blank=True, null=True)
    turbine_elec_capacity = models.IntegerField(_("Local Turbine Electricity Generation Capacity"), blank=True, null=True)
    chp_elec_capacity = models.IntegerField(_("Local CHP natual gas Electricity Generation Capacity"), blank=True, null=True)
    high_efficiency_gas_elec_capacity = models.IntegerField(_("Local High Efficiency Electricity generation Capacity"), blank=True, null=True)
    local_other_gas_elec_capacity = models.IntegerField(_("Local other Gas Electricity Generation Capacity"), blank=True, null=True)
    wind_elec_capacity = models.IntegerField(_("Wind Solar PV Electricity Generation Capacity"), blank=True, null=True)
    solar_pv_elec_capacity = models.IntegerField(_("Wind Solar PV Electricity Generation Capacity"), blank=True, null=True)
    biomass_elec_capacity = models.IntegerField(_("Biomass Electricity Generation Capacity"), blank=True, null=True)
    hydro_elec_capacity = models.IntegerField(_("Hydro Electricity Generation"), blank=True, null=True)
    geothermal_elec_capacity = models.IntegerField(_("Geothermal Electricity Generation Capacity"), blank=True, null=True)
    other_local_elec_capacity = models.IntegerField(_("Other Renewable Electricity Generation Capacity"), blank=True, null=True)

    bulk_coal = models.IntegerField(_("Purchased Bulk Coal Electricity"), blank=True, default=0)
    bulk_petroleum = models.IntegerField(_("Purchased Bulk Petroleum Electricity"), blank=True, default=0)
    bulk_simple_gas = models.IntegerField(_("Purchased Bulk Simple Gas Electricity"), blank=True, default=0)
    bulk_high_eff_gas = models.IntegerField(_("Purchased Bulk High Efficiency Electricity"), blank=True, default=0)
    bulk_hydro = models.IntegerField(_("Purchased Bulk Hydro Electricity"), blank=True, default=0)
    bulk_nuclear = models.IntegerField(_("Purchased Bulk Nuclear Electricity"), blank=True, default=0)
    bulk_solar_pv_wind = models.IntegerField(_("Purchased Bulk Solar and Wind Electricity"), blank=True, default=0)
...
class CreditsValueMapping(models.Model):
    ...
    value = models.FloatField(_("Input Value"))
